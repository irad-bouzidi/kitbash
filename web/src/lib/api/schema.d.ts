...
export interface paths {
    ...
    "/api/v1/contributed-recipes/{id}/revoke": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/v1/contributed-recipes/{id}/approve": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    revoke: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "*/*": components["schemas"]["RevocationResponse"];
                };
            };
        };
    };
