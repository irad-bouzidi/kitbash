...
class WidgetExceptionHandler {
    ...
    ProblemDetail notFound(WidgetNotFoundException exception) {
    ...
    ProblemDetail duplicate(DuplicateWidgetNameException exception) {
